package idv.hank.explorer.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, idv.hank.explorer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, idv.hank.explorer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
