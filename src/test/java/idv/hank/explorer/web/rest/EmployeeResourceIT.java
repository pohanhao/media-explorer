...
import idv.hank.explorer.domain.Employee;
import idv.hank.explorer.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    private static final Instant SMALLER_HIRE_DATE = Instant.ofEpochMilli(-1L);
